...
import { CurrentUser, createUserProfile, getUserProfile, } from "../controllers/user/user.js";
...
router.patch("/profile", validateSchema(userProfileSchema), upload.single("profileImage"), createUserProfile);
