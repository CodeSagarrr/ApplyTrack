...
export const GetMatrixData = async (req, res, next) => {
    try {
        const { userId } = req;
        ...
        const analyzedApplications = data.averageMatchScore?.[0]?.analyzedApplications ?? 0;
        const averageMatchScore = data.averageMatchScore?.[0]?.average !== null
