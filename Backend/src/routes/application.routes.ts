...
import {
  createApplication,
  getFiltersApplication,
  getSpecificApplication,
  updateApplication,
  deleteApplication,
  atsService,
  getAllApplications,
  specificApplicationAtsService,
} from "../controllers/application/application.js";
import {
  ValidateApplicationCreation,
  ValidateApplicationUpdation,
} from "../validations/application.validate.js";
...
router.post(
  "/applications",
  validateSchema(ValidateApplicationCreation),
  createApplication,
);
...
router.patch(
  "/applications/:id",
  validateSchema(ValidateApplicationUpdation),
  updateApplication,
);
router.delete("/applications/:id", deleteApplication);
router.post(
  "/applications/:applicationId/application-ats",
  aiSeviceLimits,
  specificApplicationAtsService,
);
